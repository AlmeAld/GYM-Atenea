...
const MyDocument = () => (
  <Document>
    <Page style={styles.body}>
      <Text style={styles.title}>Documento Proveedor</Text>
      <br></br>
      <br></br>
      <br></br>
      <Text style={styles.subtitle}>Grupo sas.</Text>
      <br></br>
      <br></br>
      <Text style={styles.text}>
        ...
        convivencia pacifica y la vigencia de un orden justo. Las autoridades de
