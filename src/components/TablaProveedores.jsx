              ...
              {rowData.map((row) => (
                <TableRow key={row.id}>
                  <TableCell>
                    ...
                    >
                      <path
                        d="M14.1667 2.68926C14.3856 2.47039 14.6454 2.29677 14.9314 2.17832C15.2173 2.05987 15.5238 1.9989 15.8334 1.9989C16.1429 1.9989 16.4494 2.05987 16.7353 2.17832C17.0213 2.29677 17.2812 2.47039 17.5 2.68926C17.7189 2.90813 17.8925 3.16796 18.011 3.45393C18.1294 3.7399 18.1904 4.0464 18.1904 4.35592C18.1904 4.66545 18.1294 4.97195 18.011 5.25792C17.8925 5.54388 17.7189 5.80372 17.5 6.02259L6.25002 17.2726L1.66669 18.5226L2.91669 13.9393L14.1667 2.68926Z"
                        stroke="#9D7EDB"
                        stroke-width="1.5"
